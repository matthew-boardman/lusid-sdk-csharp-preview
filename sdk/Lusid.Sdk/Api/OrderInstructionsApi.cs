 ...
 *
 * The version of the OpenAPI document: 0.11.3301-mark
...
namespace Lusid.Sdk.Api
{
    ...
    public interface IOrderInstructionsApiSync : IApiAccessor
    {
        ...
        OrderInstruction GetOrderInstruction(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>));
        ...
        ApiResponse<OrderInstruction> GetOrderInstructionWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>));
        /// <summary>
        ...
        PagedResourceListOfOrderInstruction ListOrderInstructions(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        ...
        ApiResponse<PagedResourceListOfOrderInstruction> ListOrderInstructionsWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>));
        /// <summary>
        ...
        ResourceListOfOrderInstruction UpsertOrderInstructions(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest));
        ...
        ApiResponse<ResourceListOfOrderInstruction> UpsertOrderInstructionsWithHttpInfo(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest));
    ...
    public interface IOrderInstructionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteOrderInstructionAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteOrderInstructionWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] Get OrderInstruction
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<OrderInstruction> GetOrderInstructionAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ResourceListOfOrderInstruction> UpsertOrderInstructionsAsync(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfOrderInstruction>> UpsertOrderInstructionsWithHttpInfoAsync(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OrderInstructionsApi : IOrderInstructionsApi
    {
        ...
        /// <param name="code">The orderInstruction&#39;s code. This, together with the scope uniquely identifies the orderInstruction to delete.</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteOrderInstructionWithHttpInfo(string scope, string code)
        {
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "0.11.3301-mark");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteOrderInstructionAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteOrderInstructionWithHttpInfoAsync(scope, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse>> DeleteOrderInstructionWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling OrderInstructionsApi->DeleteOrderInstruction");
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;OrderInstruction\&quot; domain to decorate onto the orderInstruction.              These take the format {domain}/{scope}/{code} e.g. \&quot;OrderInstruction/system/Name\&quot;. (optional)</param>
        /// <returns>OrderInstruction</returns>
        public OrderInstruction GetOrderInstruction(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;OrderInstruction\&quot; domain to decorate onto the orderInstruction.              These take the format {domain}/{scope}/{code} e.g. \&quot;OrderInstruction/system/Name\&quot;. (optional)</param>
        /// <returns>ApiResponse of OrderInstruction</returns>
        public Lusid.Sdk.Client.ApiResponse<OrderInstruction> GetOrderInstructionWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of OrderInstruction</returns>
        public async System.Threading.Tasks.Task<OrderInstruction> GetOrderInstructionAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<OrderInstruction> localVarResponse = await GetOrderInstructionWithHttpInfoAsync(scope, code, asAt, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;OrderInstruction\&quot; domain to decorate onto each orderInstruction.                  These take the format {domain}/{scope}/{code} e.g. \&quot;OrderInstruction/system/Name\&quot;. (optional)</param>
        /// <returns>PagedResourceListOfOrderInstruction</returns>
        public PagedResourceListOfOrderInstruction ListOrderInstructions(DateTimeOffset? asAt = default(DateTimeOffset?), string page = default(string), List<string> sortBy = default(List<string>), int? limit = default(int?), string filter = default(string), List<string> propertyKeys = default(List<string>))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfOrderInstruction> localVarResponse = await ListOrderInstructionsWithHttpInfoAsync(asAt, page, sortBy, limit, filter, propertyKeys, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="orderInstructionSetRequest">The collection of orderInstruction requests. (optional)</param>
        /// <returns>ResourceListOfOrderInstruction</returns>
        public ResourceListOfOrderInstruction UpsertOrderInstructions(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest))
        {
        ...
        /// <param name="orderInstructionSetRequest">The collection of orderInstruction requests. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfOrderInstruction</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfOrderInstruction> UpsertOrderInstructionsWithHttpInfo(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfOrderInstruction</returns>
        public async System.Threading.Tasks.Task<ResourceListOfOrderInstruction> UpsertOrderInstructionsAsync(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfOrderInstruction> localVarResponse = await UpsertOrderInstructionsWithHttpInfoAsync(orderInstructionSetRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfOrderInstruction)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfOrderInstruction>> UpsertOrderInstructionsWithHttpInfoAsync(OrderInstructionSetRequest orderInstructionSetRequest = default(OrderInstructionSetRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
