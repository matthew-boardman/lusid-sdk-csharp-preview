...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfIUnitDefinitionDto : IEquatable<ResourceListOfIUnitDefinitionDto>
    {
        /// <summary>
        ...
        public ResourceListOfIUnitDefinitionDto(List<IUnitDefinitionDto> values = default(List<IUnitDefinitionDto>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfIUnitDefinitionDto and cannot be null");
            this.Href = href;
            this.Links = links;
