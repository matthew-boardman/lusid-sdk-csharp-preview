...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfGetCounterpartyAgreementResponse : IEquatable<ResourceListOfGetCounterpartyAgreementResponse>
    {
        /// <summary>
        ...
        public ResourceListOfGetCounterpartyAgreementResponse(List<GetCounterpartyAgreementResponse> values = default(List<GetCounterpartyAgreementResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfGetCounterpartyAgreementResponse and cannot be null");
            this.Href = href;
            this.Links = links;
