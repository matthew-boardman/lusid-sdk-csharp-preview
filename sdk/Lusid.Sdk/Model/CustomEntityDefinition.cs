...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustomEntityDefinition : IEquatable<CustomEntityDefinition>
    {
        ...
        public CustomEntityDefinition(string href = default(string), string customEntityId = default(string), string displayName = default(string), string description = default(string), string entityType = default(string), List<CustomEntityFieldDefinition> fieldSchema = default(List<CustomEntityFieldDefinition>))
        {
            ...
            this.CustomEntityId = customEntityId ?? throw new ArgumentNullException("customEntityId is a required property for CustomEntityDefinition and cannot be null");
