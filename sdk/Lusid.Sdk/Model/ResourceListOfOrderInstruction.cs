...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfOrderInstruction : IEquatable<ResourceListOfOrderInstruction>
    {
        /// <summary>
        ...
        public ResourceListOfOrderInstruction(List<OrderInstruction> values = default(List<OrderInstruction>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfOrderInstruction and cannot be null");
            this.Href = href;
            this.Links = links;
