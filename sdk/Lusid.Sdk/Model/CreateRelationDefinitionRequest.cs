...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateRelationDefinitionRequest : IEquatable<CreateRelationDefinitionRequest>
    {
        ...
        public CreateRelationDefinitionRequest(string scope = default(string), string code = default(string), string sourceEntityDomain = default(string), string targetEntityDomain = default(string), string displayName = default(string), string outwardDescription = default(string), string inwardDescription = default(string), string lifeTime = default(string), string constraintStyle = default(string))
        {
            ...
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for CreateRelationDefinitionRequest and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for CreateRelationDefinitionRequest and cannot be null");
            // to ensure "sourceEntityDomain" is required (not null)
            this.SourceEntityDomain = sourceEntityDomain ?? throw new ArgumentNullException("sourceEntityDomain is a required property for CreateRelationDefinitionRequest and cannot be null");
            // to ensure "targetEntityDomain" is required (not null)
            this.TargetEntityDomain = targetEntityDomain ?? throw new ArgumentNullException("targetEntityDomain is a required property for CreateRelationDefinitionRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateRelationDefinitionRequest and cannot be null");
            // to ensure "outwardDescription" is required (not null)
            this.OutwardDescription = outwardDescription ?? throw new ArgumentNullException("outwardDescription is a required property for CreateRelationDefinitionRequest and cannot be null");
            // to ensure "inwardDescription" is required (not null)
            this.InwardDescription = inwardDescription ?? throw new ArgumentNullException("inwardDescription is a required property for CreateRelationDefinitionRequest and cannot be null");
        ...
        [DataMember(Name = "sourceEntityDomain", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "targetEntityDomain", IsRequired = true, EmitDefaultValue = false)]
