...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfA2BMovementRecord")]
    public partial class ResourceListOfA2BMovementRecord : IEquatable<ResourceListOfA2BMovementRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfA2BMovementRecord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfA2BMovementRecord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfA2BMovementRecord" /> class.
        /// </summary>
        ...
        public ResourceListOfA2BMovementRecord(List<A2BMovementRecord> values = default(List<A2BMovementRecord>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfA2BMovementRecord and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        {
            return this.Equals(input as ResourceListOfA2BMovementRecord);
        }

        /// <summary>
        /// Returns true if ResourceListOfA2BMovementRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfA2BMovementRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfA2BMovementRecord input)
        {
            if (input == null)
                return false;
