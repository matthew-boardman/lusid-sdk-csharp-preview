...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InterestRateSwap : LusidInstrument, IEquatable<InterestRateSwap>
    {
        /// <summary>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CashSettled, CdsIndex, Basket, FundingLeg, CrossCurrencySwap, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo (required) (default to &quot;InterestRateSwap&quot;).</param>
        public InterestRateSwap(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), List<InstrumentLeg> legs = default(List<InstrumentLeg>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            this.StartDate = startDate;
            this.MaturityDate = maturityDate;
            // to ensure "legs" is required (not null)
            this.Legs = legs ?? throw new ArgumentNullException("legs is a required property for InterestRateSwap and cannot be null");
        }
