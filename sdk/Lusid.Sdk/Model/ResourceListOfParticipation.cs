...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfParticipation : IEquatable<ResourceListOfParticipation>
    {
        /// <summary>
        ...
        public ResourceListOfParticipation(List<Participation> values = default(List<Participation>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfParticipation and cannot be null");
            this.Href = href;
            this.Links = links;
