...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfCorporateActionSource : IEquatable<PagedResourceListOfCorporateActionSource>
    {
        /// <summary>
        ...
        public PagedResourceListOfCorporateActionSource(string nextPage = default(string), string previousPage = default(string), List<CorporateActionSource> values = default(List<CorporateActionSource>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCorporateActionSource and cannot be null");
