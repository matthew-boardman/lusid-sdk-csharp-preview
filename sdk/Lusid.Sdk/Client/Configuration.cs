...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.3308-mark";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.11.3308-mark/csharp";
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.3308-mark\n";
            report += "    SDK Package Version: 0.11.3308-mark\n";
